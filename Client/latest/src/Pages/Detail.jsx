  ...
  return (
    <div className="detail-page">
      ...
      <div className="detail-header">
          <h1 className="text-gradient">Sports Details</h1>
          <p style={{color: 'var(--text-secondary)'}}>Explore the variety of sports offered at ALLMITSPORT</p>
      </div>
      ...
      <div className="detail-content">
        <div className="sport-grid">
          ...
          <div className="sport-card-container">
            ...
            <div className="card-content">
              ...
              <p className="card-description">
                ...
                shuttlecock back and forth over the net using racquets.
              </p>
            </div>
          </div>
          ...
          <div className="sport-card-container">
            <div className="card-img-container">
              <img className="card-img" src={swim} alt="Swimming" />
            </div>
            <div className="card-content">
          ...
          <div className="sport-card-container">
            <div className="card-img-container">
              <img className="card-img" src={kho} alt="Kho-Kho"/>
            </div>
            <div className="card-content">
          ...
          <div className="sport-card-container">
            <div className="card-img-container">
              <img className="card-img" src={volly} alt="VolleyBall" />
            </div>
            <div className="card-content">
          ...
          <div className="sport-card-container">
            ...
            <div className="card-content">
              ...
              <p className="card-description">
                ...
                depending on the number of rowers. They can be singles, doubles, pairs, fours, or eights.
              </p>
            </div>
          </div>
          ...
          <div className="sport-card-container">
            <div className="card-img-container">
              <img className="card-img" src={arc} alt="Archery" />
            </div>
            <div className="card-content">
              ...
              <p className="card-description">
                ...
                target accurately. Proper form and consistency are crucial.
              </p>
            </div>
          </div>
